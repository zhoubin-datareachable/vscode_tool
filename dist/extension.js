...
exports.getScssAlertTemplate = exports.getScssTemplate = void 0;
const str_1 = __webpack_require__(3);
const time_1 = __webpack_require__(4);
// 当前时间
const date = (0, time_1.getCurrentDate)("-");
const scssTemplate = [
    "/**",
    "* @file",
    `* @date ${date}`,
...
const getScssTemplate = (author) => {
    return scssTemplate.join("\n").replace(/\$1/g, author);
};
exports.getScssTemplate = getScssTemplate;
...
const getScssAlertTemplate = (author, componentName) => {
    return scssAlertTemplate
        .join("\n")
        .replace(/\$1/g, author)
        .replace(/\$2/g, (0, str_1.lowerFirst)(componentName));
};
exports.getScssAlertTemplate = getScssAlertTemplate;
 ...
 * @returns 2021-12-12
 */
const getCurrentDate = function (separate) {
    const date = new Date();
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getJsxAlertTemplate = exports.getJsxTemplate = void 0;
const str_1 = __webpack_require__(3);
const time_1 = __webpack_require__(4);
// 当前时间
const date = (0, time_1.getCurrentDate)("-");
...
const getJsxTemplate = (author, componentName) => {
    return jsxTemplate
        .join("\n")
        .replace(/\$1/g, author)
...
const getJsxAlertTemplate = (author, componentName) => {
    return jsxAlertTemplate
        .join("\n")
        .replace(/\$1/g, author)
        .replace(/\$2/g, componentName)
        .replace(/\$3/g, (0, str_1.lowerFirst)(componentName));
};
exports.getJsxAlertTemplate = getJsxAlertTemplate;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getText = exports.saveFile = void 0;
const vscode = __webpack_require__(1);
const fs = __webpack_require__(7);
/**
 * 保存文件
 */
const saveFile = (path, fileName, content) => {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const commitInputType = {
    placeHolder: "请输入提交信息(Input Commit Message)",
    ignoreFocusOut: true,
    prompt: "",
    value: "",
};
exports["default"] = commitInputType;
...
const isShowEmoji = vscode_1.workspace
    .getConfiguration("GitCommitPlugin")
    .get("ShowEmoji");
//新增的自定义commit type add custom Commit Type
const customCommitType = vscode_1.workspace
    .getConfiguration("GitCommitPlugin")
    .get("CustomCommitType");
let commitType = [
...
if (Array.isArray(customCommitType)) {
    customCommitType.forEach((item) => {
        ...
        const target = commitType.find((type) => typeof item.key === "string" &&
            item.key.length > 0 &&
            type.key === item.key);
        if (target !== undefined) {
...
function emailTo(html) {
    const emailConfig = configuration.get("emailConfig");
...
const Mailer = __webpack_require__(12);
const shared = __webpack_require__(14);
const SMTPPool = __webpack_require__(47);
const SMTPTransport = __webpack_require__(54);
const SendmailTransport = __webpack_require__(55);
const StreamTransport = __webpack_require__(57);
const JSONTransport = __webpack_require__(58);
const SESTransport = __webpack_require__(59);
const fetch = __webpack_require__(17);
const packageData = __webpack_require__(23);
...
const shared = __webpack_require__(14);
const mimeTypes = __webpack_require__(27);
const MailComposer = __webpack_require__(29);
const DKIM = __webpack_require__(40);
const httpProxyClient = __webpack_require__(44);
const util = __webpack_require__(16);
const urllib = __webpack_require__(15);
const packageData = __webpack_require__(23);
const MailMessage = __webpack_require__(46);
const net = __webpack_require__(25);
const dns = __webpack_require__(24);
...
const Cookies = __webpack_require__(22);
const packageData = __webpack_require__(23);
...
const MimeNode = __webpack_require__(30);
const mimeFuncs = __webpack_require__(33);
...
const mimeFuncs = __webpack_require__(33);
const qp = __webpack_require__(35);
const base64 = __webpack_require__(34);
const addressparser = __webpack_require__(36);
const fetch = __webpack_require__(17);
const LastNewline = __webpack_require__(37);

const LeWindows = __webpack_require__(38);
const LeUnix = __webpack_require__(39);
...
const Transform = (__webpack_require__(21).Transform);
...
const MessageParser = __webpack_require__(41);
const RelaxedBody = __webpack_require__(42);
const sign = __webpack_require__(43);
const PassThrough = (__webpack_require__(21).PassThrough);
const fs = __webpack_require__(7);
const path = __webpack_require__(28);
const crypto = __webpack_require__(31);
...
const EventEmitter = __webpack_require__(13);
const PoolResource = __webpack_require__(48);
const SMTPConnection = __webpack_require__(49);
const wellKnown = __webpack_require__(52);
const shared = __webpack_require__(14);
const packageData = __webpack_require__(23);
...
const SMTPConnection = __webpack_require__(49);
const assign = (__webpack_require__(14).assign);
const XOAuth2 = __webpack_require__(51);
const EventEmitter = __webpack_require__(13);
...
const packageInfo = __webpack_require__(23);
...
const Stream = (__webpack_require__(21).Stream);
const fetch = __webpack_require__(17);
const crypto = __webpack_require__(31);
const shared = __webpack_require__(14);
...
const services = __webpack_require__(53);
const normalized = {};
...
const spawn = (__webpack_require__(56).spawn);
const packageData = __webpack_require__(23);
const shared = __webpack_require__(14);
...
const vscode = __webpack_require__(1);
const scss_template_1 = __webpack_require__(2);
const jsx_template_1 = __webpack_require__(5);
const file_1 = __webpack_require__(6);
const commit_input_1 = __webpack_require__(8);
const time_1 = __webpack_require__(4);
const commit_type_1 = __webpack_require__(9);
const sendEmail_1 = __webpack_require__(10);
function activate(context) {
    ...
    //选择器
    const commitDetailQuickPickOptions = {
    ...
    if (!(gitExtension === null || gitExtension === void 0 ? void 0 : gitExtension.enabled)) {
    ...
    let repo = gitExtension.getAPI(1).repositories[0];
    // 创建普通组件
    context.subscriptions.push(vscode.commands.registerCommand("extension.addComponents", (uri) => {
        ...
        // 写入文件
        (0, file_1.saveFile)(path, "index.tsx", (0, jsx_template_1.getJsxTemplate)(author, componentName));
        (0, file_1.saveFile)(path, "style.scss", (0, scss_template_1.getScssTemplate)(author));
    }));
    // 创建Alert组件
    context.subscriptions.push(vscode.commands.registerCommand("extension.addAlert", (uri) => {
        const length = uri.path.length;
        const path = uri.path.slice(1, length).replace(/\//g, "\\");
        const pathArray = path.split("\\");
        const componentName = pathArray[pathArray.length - 1];
        ...
        const author = configuration.get("author_name", "admin");
        // 写入文件
        (0, file_1.saveFile)(path, "index.tsx", (0, jsx_template_1.getJsxAlertTemplate)(author, componentName));
        (0, file_1.saveFile)(path, "style.scss", (0, scss_template_1.getScssAlertTemplate)(author, componentName));
    }));
    // 生成内容
    const generaGit = () => {
        vscode.commands.executeCommand("workbench.view.scm");
        repo.inputBox.value = `${messageConfig.icon} ${messageConfig.message} ${(0, time_1.getCurrentDate)("/")}`;
    };
    // 输入提交的内容
    const recurInputMessage = () => {
        vscode.window.showInputBox(commit_input_1.default).then((value) => {
            messageConfig.message = value !== null && value !== void 0 ? value : "";
            generaGit();
        });
    };
    // git 提交
    ...
    vscode.commands.registerCommand("extension.showGitCommit", (uri) => {
        ...
        vscode.window
            .showQuickPick(commit_type_1.default, commitDetailQuickPickOptions)
            .then((select) => {
    ...
    // 发送邮件
    context.subscriptions.push(vscode.commands.registerCommand("extension.sendEmail", (uri) => {
        const length = uri.path.length;
        const path = uri.path.slice(1, length).replace(/\//g, "\\");
        const html = (0, file_1.getText)(path);
        (0, sendEmail_1.default)(html);
    }));
}
