...
exports.getScssTemplate = void 0;
const time_1 = __webpack_require__(3);
// 当前时间
const date = time_1.getCurrentDate("-");
const scssTemplate = [
    "/**",
    "* @file",
    `* @date ${date}`,
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const vscode = __webpack_require__(1);
const nodemailer = __webpack_require__(10);
// 读取配置文件
...
const shared = __webpack_require__(13);
const SMTPPool = __webpack_require__(46);
const SMTPTransport = __webpack_require__(53);
const SendmailTransport = __webpack_require__(54);
const StreamTransport = __webpack_require__(56);
const JSONTransport = __webpack_require__(57);
const SESTransport = __webpack_require__(58);
...
const MailComposer = __webpack_require__(28);
const DKIM = __webpack_require__(39);
const httpProxyClient = __webpack_require__(43);
const util = __webpack_require__(15);
const urllib = __webpack_require__(14);
const packageData = __webpack_require__(22);
const MailMessage = __webpack_require__(45);
...
const PassThrough = __webpack_require__(20).PassThrough;
const Cookies = __webpack_require__(21);
const packageData = __webpack_require__(22);
...
const MimeNode = __webpack_require__(29);
const mimeFuncs = __webpack_require__(32);
...
const mimeFuncs = __webpack_require__(32);
const qp = __webpack_require__(34);
const base64 = __webpack_require__(33);
const addressparser = __webpack_require__(35);
const fetch = __webpack_require__(16);
const LastNewline = __webpack_require__(36);

const LeWindows = __webpack_require__(37);
const LeUnix = __webpack_require__(38);
...
const Transform = __webpack_require__(20).Transform;
...
const MessageParser = __webpack_require__(40);
const RelaxedBody = __webpack_require__(41);
const sign = __webpack_require__(42);
const PassThrough = __webpack_require__(20).PassThrough;
const fs = __webpack_require__(6);
const path = __webpack_require__(27);
const crypto = __webpack_require__(30);
...
const EventEmitter = __webpack_require__(12);
const PoolResource = __webpack_require__(47);
const SMTPConnection = __webpack_require__(48);
const wellKnown = __webpack_require__(51);
const shared = __webpack_require__(13);
const packageData = __webpack_require__(22);
...
const SMTPConnection = __webpack_require__(48);
const assign = __webpack_require__(13).assign;
const XOAuth2 = __webpack_require__(50);
const EventEmitter = __webpack_require__(12);
...
const os = __webpack_require__(25);
const crypto = __webpack_require__(30);
const DataStream = __webpack_require__(49);
const PassThrough = __webpack_require__(20).PassThrough;
const shared = __webpack_require__(13);
...
const Stream = __webpack_require__(20).Stream;
const fetch = __webpack_require__(16);
const crypto = __webpack_require__(30);
const shared = __webpack_require__(13);
...
const services = __webpack_require__(52);
const normalized = {};
...
const spawn = __webpack_require__(55).spawn;
const packageData = __webpack_require__(22);
const shared = __webpack_require__(13);
...
const jsx_template_1 = __webpack_require__(4);
const file_1 = __webpack_require__(5);
const commit_input_1 = __webpack_require__(7);
const time_1 = __webpack_require__(3);
const commit_type_1 = __webpack_require__(8);
const sendEmail_1 = __webpack_require__(9);
function activate(context) {
    ...
    context.subscriptions.push(vscode.commands.registerCommand("extension.addComponents", (uri) => {
        ...
        // 写入文件
        file_1.saveFile(path, "index.jsx", jsx_template_1.getJsxTemplate(author, componentName));
        file_1.saveFile(path, "style.scss", scss_template_1.getScssTemplate(author));
    }));
    // 生成内容
    const generaGit = () => {
        vscode.commands.executeCommand("workbench.view.scm");
        repo.inputBox.value = `${messageConfig.icon} ${messageConfig.message} ${time_1.getCurrentDate("/")}`;
    };
    // 输入提交的内容
    ...
    context.subscriptions.push(vscode.commands.registerCommand("extension.sendEmail", (uri) => {
        const length = uri.path.length;
        const path = uri.path.slice(1, length).replace(/\//g, "\\");
        const html = file_1.getText(path);
        sendEmail_1.default(html);
    }));
}
